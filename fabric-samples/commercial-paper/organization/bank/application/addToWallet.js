...
async function main() {
    ...
    try {
        ...
        const wallet = await Wallets.newFileSystemWallet('../identity/user/jasper/wallet');

        // Ofcourse the crendentials first need to be generetated in a propper manner
